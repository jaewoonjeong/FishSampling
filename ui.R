fluidPage(
  navbarPage("",
             ...
             tabPanel(strong("SCENARIO 1"), 
                      ...
                      sidebarLayout(sidebarPanel(width=5,fluidRow(
                        ...
                        fluidRow(
                          ...
                          conditionalPanel(condition = "input.clustering1 == 'yes'",plotOutput("PLOT1_1", height = "300px")),
                        ...
                        mainPanel(width=7,
                                  ...
                                  htmlOutput("Table1"),conditionalPanel(condition = "input.clustering1 == 'yes'",useShinyalert(), actionButton("btn1.2", "?")),
                                  h1(""),
             ...
             tabPanel(strong("SCENARIO 2"), 
                      ...
                      conditionalPanel(condition = "input.clustering2 == 'no'",div(HTML("<b>Total number of fish (A)</b> are sampled from a farm with <b>an assumed true abundance (B)</b>. <b><u>The output is the probability</b></u> that the abundance estimated through this sampling will be higher than <b>a certain level of abundance (F)</b>."))),
                      conditionalPanel(condition = "input.clustering2 == 'yes'",div(HTML("<b>Total number of fish (A)</b> are sampled from a farm consisting of <b>(D) a certain number of pens</b> with <b>an assumed true abundance (B)</b>. The fish are sampled from <b>selected numbers of pens (C)</b>. <b><u>The output is the probability</b></u> that the abundance estimated through this sampling will be higher than <b>a certain level of abundance (F)</b>."))),
                      p(""),
                      sidebarLayout(sidebarPanel(width=5,fluidRow(
                        column(6,
                               selectInput("TSS2", "(A) Total number of  fish to sample from a farm:",choices = 1:1000,selected=c(60),multiple = TRUE),
                               numericInput("ab2", "(B) Assumed True Abundance:", value =2.6, min=0, max=10, step=0.01),
                               numericInput("th2","(F) Certain level of abundance:",value=3,min=0,max=10,step=0.01)),
                        column(6,
                               ...
                               conditionalPanel(condition = "input.clustering2 == 'yes'",sliderInput("pen2", "(D) Number of pens in a farm:", value=10, min=2, max=20)),
                               conditionalPanel(condition = "input.clustering2 == 'yes'",sliderInput("icc2", "(E) ICC:", value=0.01, min=0.01, max=0.35,step = 0.01)))),
                        conditionalPanel(condition = "input.clustering2 == 'yes'",plotOutput("PLOT2_2", height = "300px")),
                        conditionalPanel(condition = "input.clustering2 == 'yes'",h4(""))),
                        mainPanel(width=7,
                                  actionButton("goButton2", "Go!", class = "btn-primary"),
                                  h1(""),
                                  conditionalPanel(condition = "input.clustering2 == 'no'",div(HTML("<b><u>Probability of estimating abundance higher than the certain level of abundance </b></u>"))),
                                  conditionalPanel(condition = "input.clustering2 == 'yes'",div(HTML("<b><u>Probability of estimating abundance higher than the certain level of abundance </b></u>and<i> (Number of sampled fish per pen)</i>"))),
                                  htmlOutput("Table2"),conditionalPanel(condition = "input.clustering2 == 'yes'",useShinyalert(),   actionButton("btn2.2", "?")),
                                  h1(""),
                                  plotOutput("PLOT2"),useShinyalert(),  actionButton("btn2.3", "?"),
                                  h1(""),
             ...
             tabPanel(strong("SCENARIO 3"), 
                      ...
                      conditionalPanel(condition = "input.clustering3 == 'no'",div(HTML("<b>Total number of fish (A)</b> are sampled from each of two farms with <b>assumed true (lower) Abundance1 (B) and (higher) Abundance2 (F)</b>. <b><u>The output is the probability</b></u> that this sampling will determine that Abundance1 (B) is lower than Abundance2 (F)."))),
                      conditionalPanel(condition = "input.clustering3 == 'yes'",div(HTML("<b>Total number of fish (A)</b> are sampled from each of two farms consisting of <b>(D) a certain number of pens</b> with <b>assumed true (lower) Abundance1 (B) and (higher) Abundance2 (F)</b>. The fish are sampled from <b> selected numbers of pens (C)</b>. <b><u>The output is the probability</b></u> that this sampling will determine that Abundance1 (B) is lower than Abundance2 (F)."))),
                      p(""),
                      sidebarLayout(sidebarPanel(width=5,fluidRow(
                        column(6,
                               selectInput("TSS3","(A) Total number of sampled fish from each farm:",choices=1:1000,selected=c(60),multiple=TRUE),
                               numericInput("ab3_1", "(B) Assumed True (lower) Abundance1:", value =1.3, min=0, max=10, step=0.01),
                               numericInput("ab3_2", "(F) Assumed True (higher) Abundance2:", value =1.7, min=0, max=10, step=0.01)),
                        column(6,
                               ...
                               conditionalPanel(condition = "input.clustering3 == 'yes'",sliderInput("pen3", "(D) Total Number of pens in a farm:", value=10, min=2, max=20)),
                               conditionalPanel(condition = "input.clustering3 == 'yes'",sliderInput("icc3_1", "(E-1) ICC1:", value=0.01, min=0.01, max=0.35,step = 0.01)),
                               conditionalPanel(condition = "input.clustering3 == 'yes'",sliderInput("icc3_2", "(E-2) ICC2:", value=0.01, min=0.01, max=0.35,step = 0.01)))),
                        conditionalPanel(condition = "input.clustering3 == 'yes'",plotOutput("PLOT3_3", height = "300px")),
                        conditionalPanel(condition = "input.clustering3 == 'yes'",h4(""))),
                        mainPanel(width=7,
                                  actionButton("goButton3", "Go!", class = "btn-primary"),
                                  h1(""),
                                  conditionalPanel(condition = "input.clustering3 == 'no'",div(HTML("<b><u>Probability of determining that Abundance1 is lower than Abundance2</b></u>"))),
                                  conditionalPanel(condition = "input.clustering3 == 'yes'",div(HTML("<b><u>Probability of determining that Abundance1 is lower than Abundance2</b></u> and<i> (Number of sampled fish per pen)</i>"))),
                                  htmlOutput("Table3"),conditionalPanel(condition = "input.clustering3 == 'yes'",useShinyalert(), actionButton("btn3.2", "?")),
                                  h1(""),
                                  plotOutput("PLOT3"),
